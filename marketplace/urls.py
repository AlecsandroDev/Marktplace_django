...
urlpatterns = [
    ...
    path('admin/gerenciar_usuario', views.admin_gerenciar_usuario, name='admin_gerenciar_usuario'),
    path('admin/reportes', views.admin_reportes, name='admin_reportes'),
    path('admin/gerenciar_reporte', views.admin_gerenciar_reporte, name='admin_gerenciar_reporte'),
    path('admin/reportes_arquivados', views.admin_reportes_arquivados, name='admin_reportes_arquivados'),
    path('admin/gerenciar_reporte_arquivado', views.admin_gerenciar_reporte_arquivado, name='admin_gerenciar_reporte_arquivado'),
    path('admin/pedidos', views.admin_pedidos, name='admin_pedidos'),
    path('admin/gerenciar_pedido', views.admin_gerenciar_pedido, name='admin_gerenciar_pedidos'),
    path('admin/pedidos_finalizados', views.admin_pedidos_finalizados, name='admin_pedidos_finalizados'),
    path('admin/gerenciar_pedido_finalizado', views.admin_gerenciar_pedido_finalizado, name='admin_gerenciar_pedido_finalizado'),
